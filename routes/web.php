...
Route::post('/contato/enviar',array(
	'as'	=> 'site.contato.enviar',
	'uses' => 'Site\PaginaController@enviarContato'
));

Route::get('/imovel/{id}/{titulo?}',array(
	'as'	=> 'site.imovel',
...
Route::group(['middleware' => 'auth'],function(){
	...
	Route::post('/admin/papel/permissao/adicionar/{id}',[
		'as'	=> 'admin.papel.permissao.adicionar',
		'uses'	=> 'Admin\PapelController@adicionarPermissao'
	]);
