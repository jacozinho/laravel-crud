	    	...
	    	<div class="col s12 m8">
	    			...
	    			<div class="slider">
	    				<ul class="slides">
	    					@foreach($galeria as $imagem)
		    					<li>
		    						<img class="responsive-img" src="{{asset($imagem->imagem)}}">
	    		...
	    		@endif
	    			<div class="row" align="center">
	    				<button onclick="slidePrev()" class="btn blue">Anterior</button>
	    				<button onclick="slideNext()" class="btn blue">Próximo</button>
	    			</div>
	    		</div>
	    	</div>
