	...
	<form action="{{route('site.busca')}}">
		...
		<div class='input-field col s6 m3'>
			<select name="dormitorios">
				<option {{isset($busca['dormitorios']) && $busca['dormitorios'] == 'todos' ? 'selected' : ''}} value="0">Todos</option>
		...
		<div class='input-field col s12 m4'>
			<select name="valor">
				...
				<option {{isset($busca['valor']) && $busca['valor'] == 2 ? 'selected' : ''}} value="2">De R$500,00 a R$ 1.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 3 ? 'selected' : ''}} value="3">De R$1.000,00 a R$ 5.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 4 ? 'selected' : ''}} value="4">De R$5000,00 a R$ 10.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 5 ? 'selected' : ''}} value="5">De R$10.000,00 a R$ 50.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 6 ? 'selected' : ''}} value="6">De R$50.000,00 a R$ 100.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 7 ? 'selected' : ''}} value="7">De R$100.000,00 a R$ 200.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 8 ? 'selected' : ''}} value="8">De R$200.000,00 a R$ 300.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 9 ? 'selected' : ''}} value="9">De R$300.000,00 a R$ 500.000,00</option>
				<option {{isset($busca['valor']) && $busca['valor'] == 10 ? 'selected' : ''}} value="10">De R$500.000,00 a R$ 1.000.000,00</option>
		...
		<div class='input-field col s12 m2'>
			<button class="btn deep-range darken-1 right">Filtar</button>
		</div>
	</form>
</div>