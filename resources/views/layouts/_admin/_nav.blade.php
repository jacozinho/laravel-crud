  ...
  <div class="nav-wrapper blue">
    <div class="container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a target="_blanck" href="{{route('site.home')}}">Ver Site</a></li>
        @if(Auth::guest())
          <li><a href="{{route('admin.login')}}">Login</a></li>
        @else
          <li><a class="dropdown-button blue" href="#!" data-activates="dropdown1">{{Auth::user()->name}}<i class="material-icons right">arrow_drop_down</i></a></li>
          ...
          <ul id="dropdown1" class="dropdown-content">
            ...
            @can('papel_listar')
              <li><a href="{{route('admin.papel')}}">Papeis</a></li>
            @endcan
